...
//	email  : pinotoy@yahoo.com
	...
	var img      = new Array();
	var bShow    = false;
	var ieMacVar = (navigator.appVersion.indexOf("Mac") != -1) && (navigator.userAgent.indexOf("MSIE") != -1);

	/* determines if running in IE on the Mac */
	function ieMac() {
		if (ieMacVar==true) {
			return true;
		}
	...
	*/
	...
	function showCalendar(ctl, ctl2, format, lang, past, fx, fy, imgUrl) {
