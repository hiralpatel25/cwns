...
/**
 * EfEffluentLimitId generated by hbm2java
 */
public class EfEffluentLimitId implements java.io.Serializable {
	...
	/** default constructor */
	public EfEffluentLimitId() {
	}

	/** full constructor */
	public EfEffluentLimitId(String efNpdesPermitNumber,
			String efDischargeNum, String efReportDesig,
			char efPipeSetQualifier, String efLimitType, String efParamCode,
			String efMonitoringLoc, String efSeasonNum, String efModifNum) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EfEffluentLimitId))
			return false;
		EfEffluentLimitId castOther = (EfEffluentLimitId) other;
		...
		return ((this.getEfNpdesPermitNumber() == castOther
				...
				&& ((this.getEfLimitType() == castOther.getEfLimitType()) || (this
						...
						.getEfLimitType().equals(castOther.getEfLimitType())))
				&& ((this.getEfParamCode() == castOther.getEfParamCode()) || (this
						.getEfParamCode() != null
						&& castOther.getEfParamCode() != null && this
						.getEfParamCode().equals(castOther.getEfParamCode())))
				&& ((this.getEfMonitoringLoc() == castOther
						.getEfMonitoringLoc()) || (this.getEfMonitoringLoc() != null
				...
				&& ((this.getEfSeasonNum() == castOther.getEfSeasonNum()) || (this
						...
						.getEfSeasonNum().equals(castOther.getEfSeasonNum())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getEfMonitoringLoc() == null ? 0 : this.getEfMonitoringLoc()
						.hashCode());
		result = 37
				* result
