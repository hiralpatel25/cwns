...
/**
 * FederalReviewStatusId generated by hbm2java
 */
public class FederalReviewStatusId implements java.io.Serializable {
	...
	/** default constructor */
	public FederalReviewStatusId() {
	}

	/** full constructor */
	public FederalReviewStatusId(long facilityId, long dataAreaId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FederalReviewStatusId))
			return false;
		FederalReviewStatusId castOther = (FederalReviewStatusId) other;
