...
/**
 * Rehab Individual Wastewater Treament System - Conventional
 * 
 * Category: 		XII
 * 
 */
...
public class RehabIndividualWastewaterTreatmentConventionalAlgorithm extends
	...
	public CostCurveOutput execute(CostCurveInput costInput) throws CostCurveException {
		...
		long cost1 = Math.round(2114 * ((x1 * y1) + (x2 * y2)) * z);
