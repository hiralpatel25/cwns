...
public class RehabSeparateSewerCostInputProcessor extends SeparateSewerCostInputProcessor { 
	...
	public CostCurveInput getCostInputData(Long facilityId){
		...
		ci.setPresentPopulation(populationService.getPresentRehabSeparateSewerSystemPopulation(facilityId));
