...
/**
 * New Individual Wastewater Treatment System - Conventional
 * 
 * Category: 		XII
 * Algorithm: 		Cost ($) = 2675 * ((X1 * Y1) + (X2 * Y2))	
 * 
 */


public class NewIndividualWastewaterTreatmentConventionalAlgorithm extends
	...
	public CostCurveOutput execute(CostCurveInput costInput) throws CostCurveException {
		...
		long cost1 = Math.round(2675 * ((x1 * y1) + (x2 * y2)) * z);
