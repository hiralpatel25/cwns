...
/**
 * Rehab Individual Wastewater Treament System - all
 * 
 * Category: 		XII
 * Algorithm: 		Cost ($) = 2963 * ((X1 * Y1) + (X2 * Y2)) * Z	
 * Where 
...
public class RehabIndividualWastewaterTreatmentAllAlgorithm extends
	...
	public CostCurveOutput execute(CostCurveInput costInput) throws CostCurveException {
		...
		long cost1 = Math.round(2963 * ((x1 * y1) + (x2 * y2)) * z);
